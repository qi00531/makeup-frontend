...
export function EyeGuidePage() {
  ...
  useEffect(() => { void learningService.getEyeGuides().then(setGuides); }, []);
  ...
  return (
    <MobileShell withNav className="learning-page eye-page">
      <header className="detail-header"><button className="icon-button" type="button" aria-label="返回" onClick={() => navigate('/tutorial')}><ArrowLeft size={21} /></button><div><span className="page-kicker">EYE DETAIL</span><h1>眼部精讲</h1></div><span className="header-spacer" /></header>
